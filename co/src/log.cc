...
DEF_string(log_dir, "cologs", "#0 log dir, will be created if not exists");
...
DEF_int32(max_log_size, 4096*100, "#0 max size of a single log");
...
DEF_bool(cout, true, "#0 also logging to terminal");
